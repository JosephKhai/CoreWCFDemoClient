...
namespace ServiceReference1
{
    ...
    public interface IEchoService
    {
        ...
        System.Threading.Tasks.Task<string> ComplexEchoAsync(ServiceReference1.EchoMessage message);
    ...
    public partial class EchoServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IEchoService>, ServiceReference1.IEchoService
    {
        ...
        public System.Threading.Tasks.Task<string> ComplexEchoAsync(ServiceReference1.EchoMessage message)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            ...
            if ((endpointConfiguration == EndpointConfiguration.WSHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:6001/EchoService/WSHttps");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
